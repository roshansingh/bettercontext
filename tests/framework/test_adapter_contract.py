...
EXCLUDED_FROM_SPLIT_FIXTURE_CONTRACT = {"static-config", "python-ast", "typescript-compiler-api", "typescript-async-lifecycle", "typescript-call-result-identity-comparison", "python-swallowed-exception"}
